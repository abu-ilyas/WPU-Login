                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="<?php echo base_url('auth/registration') ?>">
                                <div class="form-group">
                                    ...
                                    <?php echo form_error('name', '<small class="text-danger pl-3">', '</small>') ?></small>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="email" placeholder="Email Address" name="email" name="name" value="<?php echo set_value('email') ?>">
